...
void Palette::init()
{
    ...
    brushStyleComboBox = new QComboBox;             //画刷的各种风格
...
void Palette::createStyleComboBox()
{
    ...
    penStyleComboBox->setItemDelegate(new PenStyleDelegate((QObject *)penStyleComboBox));
...
void Palette::brushChanged()
{
    ...
    } else if (style == Qt::RadialGradientPattern) {    //辐射渐变
